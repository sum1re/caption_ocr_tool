...
fun NodeELWrapper.whileDo(elWrapper: ELWrapper): WhileELWrapper = ELBus.whileOpt(this).doOpt(elWrapper)
...
fun NodeELWrapper.iterator(elWrapper: ELWrapper): IteratorELWrapper = ELBus.iteratorOpt(this).doOpt(elWrapper)